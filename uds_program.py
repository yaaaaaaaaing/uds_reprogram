...
class uds_request:
    def __init__(self,bus,req_id,resp_id,fd_flag,frame_max_len,dll_file):
        self.bus = bus
        self.req_id = req_id
    ...
    def uds_session_request(self,session_type):
        ...
        ret_value,resp_data = uds_cantp_send(self.bus,self.req_id,self.resp_id,req_data,self.fd_flag,self.frame_max_len)
        if ret_value != True:
